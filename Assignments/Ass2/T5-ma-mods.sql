...
ALTER TABLE parts_sale_item ADD CONSTRAINT parts_sale_item_pk PRIMARY KEY ( sale_no,
                                                                            part_code
                                                                            );
ALTER TABLE parts_sale_item
    ADD CONSTRAINT parts_sale_item_sale_fk FOREIGN KEY ( sale_no )
        REFERENCES parts_sale ( sale_no );
ALTER TABLE parts_sale_item
    ADD CONSTRAINT parts_sale_item_part_fk FOREIGN KEY ( part_code )
...
UPDATE part
   SET part_reorder_level = ceil(part_stock / 2),
...
ALTER TABLE part MODIFY
    part_reorder_level NOT NULL;
ALTER TABLE part MODIFY
    part_restock_date NOT NULL;
