...
UPDATE service 
SET serv_ready_pickup = TO_DATE(TO_CHAR(serv_req_pickup, 'DD/MM/YYYY') || ' 17:15', 'DD/MM/YYYY HH24:MI')
WHERE serv_no = 102;

-- For service 103 (Oil change)
UPDATE service 
SET serv_ready_pickup = TO_DATE(TO_CHAR(serv_req_pickup, 'DD/MM/YYYY') || ' 15:30', 'DD/MM/YYYY HH24:MI')
WHERE serv_no = 103;

-- view times as oracle doesn't show time by default
SELECT
    serv_no,
    TO_CHAR(serv_drop_off, 'DD/MM/YYYY HH24:MI') AS drop_off_time,
    TO_CHAR(serv_req_pickup, 'DD/MM/YYYY HH24:MI') AS serv_req_pickup_time,
    TO_CHAR(serv_ready_pickup, 'DD/MM/YYYY HH24:MI') AS serv_ready_pickup_time
FROM service
ORDER BY serv_no;
